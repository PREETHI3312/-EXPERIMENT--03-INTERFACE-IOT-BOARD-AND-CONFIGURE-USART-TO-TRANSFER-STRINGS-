...
#define PUTCHAR_PROTOTYPE int __io_putchar(int ch)
  ...
  while (1)
  {
		printf("vasanth saveeetha engg0\n");
		HAL_Delay(500);
...
![WhatsApp Image 2024-02-28 at 10 00 44_ad5abdf2](https://github.com/PREETHI3312/-EXPERIMENT--03-INTERFACE-IOT-BOARD-AND-CONFIGURE-USART-TO-TRANSFER-STRINGS-/assets/151625222/b6d575af-9a4e-40ae-8e0b-e8abe2ab18ff)
